...
import ImageHero from "./assets/hero-background.jpg";
/*
...
export const heroSection = [
  { id: 1, title: "title", subTitle: "subTitle", image: ImageHero },
];
...
export const projectLinks1 = [
  {
    id: 1,
    href: "https://www.twitter.com/user1",
    icon: "fab fa-twitter",
...
export const projectLinks2 = [
  {
    id: 1,
    href: "https://www.twitter.com/user2",
    icon: "fab fa-twitter",
    btnClass: "btn btn-primary",
  },
  {
    id: 2,
    href: "https://www.facebook.com/user2",
    icon: "fab fa-fa-facebook",
    btnClass: "btn btn-secondary",
  },
];
...
export const projectLinks3 = [
  {
    id: 1,
    href: "https://www.twitter.com/user3",
    icon: "fab fa-twitter",
    btnClass: "btn btn-primary",
  },
  {
    id: 2,
    href: "https://www.facebook.com/user3",
    icon: "fab fa-fa-facebook",
    btnClass: "btn btn-secondary",
  },
];
